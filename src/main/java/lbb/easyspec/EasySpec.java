...
public class EasySpec implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        ServerLifecycleEvents.SERVER_STARTED.register(server -> {
            ...
            Permissions.check(console, PERM_COMMAND, ConfigManager.getInstance().get(ConfigKeys.PERMISSION_LEVEL));
            Permissions.check(console, PERM_TRIGGER, ConfigManager.getInstance().get(ConfigKeys.TRIGGER_PERMISSION_LEVEL));
